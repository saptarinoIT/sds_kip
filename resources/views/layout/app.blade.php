...
<body id="kt_body" style="background-image: url({{ asset('assets/media/patterns/header-bg.png') }})"
    class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled waitMe_body">

    <div class="waitMe_container img" style="background:#fff; z-index:99999999;">
        <div style="background:url({{ asset('template/images/logo.png') }}); background-size: auto 80px;"
            class="ld ld-breath"></div>
    </div>
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div id="kt_header" class="header align-items-stretch" data-kt-sticky="true"
                    data-kt-sticky-name="header" data-kt-sticky-offset="{default: '60px', lg: '150px'}">
                    <!--begin::Container-->
