  ...
  <div class="card-body py-4">
    ...
    <form action="{{ route('alternatif.update', $alternatif->id) }}" method="POST">
      ...
      <div class="mb-3">
        ...
        <input class="form-control" name="id_alternatif" type="hidden" value="{{ $alternatif->id }}" readonly required>
      </div>
      <div class="mb-3">
        <label class="form-label">Jenjang</label>
        <input class="form-control" type="text" value="{{ strtoupper($alternatif->jenjang) }}" readonly required>
      </div>
      <div class="mb-3">
