...
<div class="page-title d-flex flex-column me-3">
  ...
  <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
    ...
    <li class="breadcrumb-item text-white opacity-75 small">Edit Data Kriteria</li>
  </ul>
</div>
@endsection
  ...
  <div class="card-body py-4">
    ...
    <form action="{{ route('kriteria.update', $kriteria->id) }}" method="POST">
      ...
      <div class="form-group row fv-row mb-5">
        ...
        <div class="col-md-10">
          <input class="form-control form-control-solid @error('kode') is-invalid @enderror" autocomplete="off" id="kode" name="kode" type="text" required value="{{ ucwords($kriteria->kode_kriteria) }}">
          @error('kode')
      ...
      <div class="form-group row fv-row mb-5">
        ...
        <div class="col-md-10">
          <input class="form-control form-control-solid @error('nama') is-invalid @enderror" autocomplete="off" id="nama" name="nama" type="text" required value="{{ ucwords($kriteria->nama_kriteria) }}">
          @error('nama')
          <div class="invalid-feedback">
            {{ $message }}
          </div>
      ...
      <div class="form-group row fv-row mb-5">
        ...
        <div class="col-md-9">
          <input class="form-control form-control-solid @error('nilai') is-invalid @enderror" autocomplete="off" id="nilai" name="nilai" type="number" required value="{{ $kriteria->bobot * 100}}">
          @error('nilai')
          <div class="invalid-feedback">
            {{ $message }}
          </div>
