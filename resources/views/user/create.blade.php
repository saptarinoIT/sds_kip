        ...
        <div class="card-body py-4">
            ...
            <form action="{{ route('user.store') }}" method="POST">
                ...
                <div class="form-group row fv-row mb-5">
                    ...
                    <div class="col-md-10">
                        <input class="form-control form-control-solid @error('username') is-invalid @enderror"
                            autocomplete="off" id="username" name="username" type="text" required>
                        @error('username')
                ...
                <div class="form-group row fv-row mb-5">
                    ...
                    <div class="col-md-10">
                        <input class="form-control form-control-solid @error('nama') is-invalid @enderror"
                            autocomplete="off" id="nama" name="nama" type="text" required>
                        @error('nama')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="form-group row fv-row mb-5">
                    ...
                    <div class="col-md-10">
                        <select name="role" id="role"
                            class="form-select form-select-solid s2x @error('role') is-invalid @enderror">
                ...
                <div class="d-flex justify-content-end">
                    <a href="{{ route('user.index') }}" click="resetForm"
                        class="btn btn-light btn-lg me-2 w-100 mb-5">Kembali</a>
